            ...
            VStack(spacing: 20) {
                ...
                VStack(spacing: 15){
                    ...
                    Button(action: { showingRandomPick = true }) {
                        HomeButtonContent(
                            icon: "brain",              // Changed from "shuffle"
                            title: "AI Pick for Me",    // Changed from "Surprise me"
                            subtitle: "Smart recommendation based on your taste",  // More descriptive
                            color: .green              // Changed from .red to differentiate
                        )
                    }
                    .buttonStyle(PlainButtonStyle())
